...
namespace Arcade {
    ...
    static keyMatching matching[] {
        ...
        {sf::Keyboard::Enter, InputKey::INTERACT},
        {sf::Keyboard::Escape, InputKey::ESCAPE},
        {sf::Keyboard::Space, InputKey::SPACE},
        {sf::Keyboard::BackSpace, InputKey::BackSpace},
        {sf::Keyboard::Num1, InputKey::SWITCH_LIB},
        {sf::Keyboard::Num3, InputKey::SWITCH_GAME},

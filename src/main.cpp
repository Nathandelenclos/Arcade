...
int main()
{
    ...
    Arcade::DlLoader<Arcade::IGraphicLib> loaderSFML("./libraries/arcade_sfml.so");
    std::shared_ptr<Arcade::IGraphicLib> libSFML = loaderSFML.getInstance();
    Arcade::DlLoader<Arcade::IGraphicLib> loaderSDL("./libraries/arcade_sdl2.so");
    std::shared_ptr<Arcade::IGraphicLib> libSDL = loaderSDL.getInstance();
    Arcade::DlLoader<Arcade::IGraphicLib> loaderNCURSES("./libraries/arcade_ncurses.so");
